...
# Table of contents
1. [Exercise 1 - Function creation](#Exercise 1)
2. [Exercise 2 - Documenting the function](#Exercise 2)
3. [Exercise 3 - Examples](#Exercise 3)
4. [Exercise 4 - Testing the function](#Exercise 4)
...
a standard significance level of 0.05, since this is the level of significance commonly used. However, this can be adjusted in the function call by specifying
the conf.level and the alt. 
...
@param ... Other parameters to pass to \code{t.test()}, such as conf.level (between 0-1) and alt ("two.sided", "less", "greater") 

@return p-value of an independent 2-sample t-test based on the equality or inequality of variance in the method 
@export 
