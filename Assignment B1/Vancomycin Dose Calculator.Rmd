...
# Table of contents
1. [Exercise 1 and 2 - Function creation and Documenting the function](#Exercise 1 and 2)
2. [Exercise 3 - Examples](#Exercise 3)
3. [Exercise 4 - Testing the function](#Exercise 4)
...
Examples (Exercise 3)
<p>Example dose calculation with patient parameters</p>
```{r}
